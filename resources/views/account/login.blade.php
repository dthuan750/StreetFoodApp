                            ...
                            <div class="contact-content">
                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="contact-form-wrap">
                                        ...
                                        <a href="{{route('account.register')}}" style="display:block; text-align: center; margin-top: 15px;">Create new account</a>
                                        <a href="{{route('account.forgot_password')}}" style="display:block; text-align: center; margin-top: 15px;">Forgot password</a>
                                    </div>
                                </form>
