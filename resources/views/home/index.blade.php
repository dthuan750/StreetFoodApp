                                    ...
                                    <div class="features-content">
                                        ...
                                        <h4 class="title"><a href="{{route('home.product', $np->id)}}">{{$np->name}}</a></h4>
                                            <div class="favorite-action">
                                                @if(auth('cus')->check())
                                                    @if($np->favorited)
                                                        <a title="bỏ thích" onclick="return confirm('Bạn có muốn bỏ thích không')" href="{{route('home.favorite', $np->id)}}"><i class="fas fa-heart"></i></a>
                                                    @else
                                                        <a title="yêu thích" href="{{route('home.favorite', $np->id)}}"><i class="far fa-heart"></i></a>
                                                    @endif

                                                        <a title="thêm vào giỏ hàng" href="{{route('cart.add', $np->id)}}"><i class="fa fa-shopping-cart"></i></a>
                                                    
                                                @else
                                                    <a title="thêm vào giỏ hàng" href="{{route('account.login')}}" onclick="alert('vui lòng đăng nhập để thêm giỏ hàng')"><i class="fa fa-shopping-cart"></i></a>
                                                @endif
                                            </div>
                            ...
                            <div class="product-item">
                                ...
                                <div class="product-content">
                                    ...
                                    <h4 class="title"><a href="{{route('home.product', $sp->id)}}">{{$sp->name}}</a></h4>
                                        ...
                                        @if(auth('cus')->check())
                                                    @if($sp->favorited)
                                                        <a title="bỏ thích" onclick="return confirm('Bạn có muốn bỏ thích không')" href="{{route('home.favorite', $sp->id)}}"><i class="fas fa-heart"></i></a>
                                                    @else
                                                        <a title="yêu thích" href="{{route('home.favorite', $sp->id)}}"><i class="far fa-heart"></i></a>
                                                    @endif

                                                        <a title="thêm vào giỏ hàng" href="{{route('cart.add', $sp->id)}}"><i class="fa fa-shopping-cart"></i></a>
                            ...
                            <div class="gallery-active">
                                @foreach($gallerys as $gallery)
                                    <div class="gallery-item">
                                        <a href="uploads/gallery/{{$gallery->image}}" class="popup-image"><img src="uploads/gallery/{{$gallery->image}}p" alt=""></a>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                            ...
                            <div class="product-item-two">
                                ...
                                <div class="product-content-two">
                                    <div class="product-info">
                                        ...
                                        @if(auth('cus')->check())
                                                @if($fp->favorited)
                                                    <a title="bỏ thích" onclick="return confirm('Bạn có muốn bỏ thích không')" href="{{route('home.favorite', $fp->id)}}"><i class="fas fa-heart"></i></a>
                                                @else
                                                    <a title="yêu thích" href="{{route('home.favorite', $fp->id)}}"><i class="far fa-heart"></i></a>
                                                @endif
                                                    <a title="thêm vào giỏ hàng" href="{{route('cart.add', $fp->id)}}"><i class="fa fa-shopping-cart"></i></a>
